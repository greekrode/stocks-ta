...
to = int(today.timestamp())# Get date ten years ago as UTC timestamp
...
price_hist = get_price_hist(symbol)
indicators = get_indicators(price_hist)
duration = int(input("Days to display: "))
plot_chart(indicators, duration, symbol)
